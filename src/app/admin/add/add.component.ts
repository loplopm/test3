...
import { UploadService } from '../../products/uploadFile/upload.service';
...
export class AddComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.productForm.addControl('image', new FormControl('', [Validators.required]));
  ...
  saveProduct(): void {
    ...
    // product.image = this.productForm.get('').value;
    // save to database
    if (product.id == 0) {
